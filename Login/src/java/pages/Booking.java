    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("text/html;charset=UTF-8");
         try (PrintWriter out = response.getWriter()) {
            ...
            //query[6] = (String)request.getParameter("hour") +":" + (String)request.getParameter("min") + ":00";
            query[6] = (String)request.getParameter("hour");
            query[7] = (String)request.getParameter("min");
            //query[7] = query[6].toString();
        ...
        {
            request.setAttribute("message", "Address cannot be NULL");
        }
